...
<nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" navbar-scroll="true">
    <div class="container-fluid py-1 px-3">
      <nav aria-label="breadcrumb">
        ...
        <h6 class="font-weight-bolder mb-0">Tambah Data Pelanggan</h6>
      </nav>
        ...
        <div class="card-body">
          <form action="{{ route('pelanggan.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
              ...
              <label>Nama</label>
              <div class="mb-3">
                <input type="text" class="form-control" name="nama" aria-label="text" aria-describedby="text-addon">
                @error('nama')
...
@enderror
              ...
              <label>Alamat</label>
              <div class="mb-3">
                <input type="text" class="form-control" name="alamat" aria-label="text" aria-describedby="text-addon">
                @error('alamat')
<div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
@enderror
              </div>
              ...
              <div class="mb-3">
                <input type="text" class="form-control" name="username" aria-label="text" aria-describedby="text-addon">
              </div>
