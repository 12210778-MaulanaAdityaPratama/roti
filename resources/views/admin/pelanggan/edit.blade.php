...
<nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" navbar-scroll="true">
    <div class="container-fluid py-1 px-3">
      <nav aria-label="breadcrumb">
        ...
        <h6 class="font-weight-bolder mb-0">Edit Data Pelanggan</h6>
      </nav>
...
@method('PUT')
              <label>Nomor</label>
              <div class="mb-3">
                <input type="text" class="form-control" name="no"  value="{{ $pelanggan->no }}"placeholder="nomor" aria-label="text" aria-describedby="text-addon">
               
              </div>
              <label>Kode</label>
              <div class="mb-3">
                <input type="text" class="form-control" name="kode"value="{{ $pelanggan->kode }}"aria-label="text" aria-describedby="text-addon">
               
              </div>
              <label>Nama</label>
              <div class="mb-3">
                <input type="text" class="form-control" name="nama" value="{{ $pelanggan->nama }}" aria-label="text" aria-describedby="text-addon">
                @error('nama')
...
@enderror
              ...
              <div class="mb-3">
                <input type="text" class="form-control" name="no_telp" value="{{ $pelanggan->no_telp }}" aria-label="text" aria-describedby="text-addon">
...
@enderror
              ...
              <label>Alamat</label>
              <div class="mb-3">
                <input type="text" class="form-control" name="alamat" value="{{ $pelanggan->alamat }}"aria-label="text" aria-describedby="text-addon">
                @error('alamat')
<div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
@enderror
              </div>
              ...
              <div class="mb-3">
                <input type="text" class="form-control" name="username" value="{{ $pelanggan->username }}" aria-label="text" aria-describedby="text-addon">
