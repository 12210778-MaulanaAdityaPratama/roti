            ...
            <table class="table align-items-center mb-0">
              <thead>
                <tr>
                  ...
                  <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Nomor Telpon</th>
                ...
                <tr>
                  <td>
                    ...
                    <div class="d-flex px-2 py-1">
                      ...
                      <div class="d-flex flex-column justify-content-center">
                        <h6 class="mb-0 text-sm">{{ $pemesanan->no }}</h6>
                      </div>
                    </div>
                  </td>
                  <td>
                    <p class="text-xs font-weight-bold mb-0">{{ $pemesanan->kode }}</p>
                  </td>
                  <td class="align-middle text-center text-sm">
                    <span class="text-secondary text-xs font-weight-bold">{{ $pemesanan->no_telp }}</span>
                  </td>
                  <td class="align-middle text-center">
                    <span class="text-secondary text-xs font-weight-bold">{{ $pemesanan->jml_beli }}</span>
                  </td>
                  <td class="align-middle text-center">
                    <span class="text-secondary text-xs font-weight-bold">{{ $pemesanan->detail }}</span>
                  </td>
                  <td class="align-middle text-center">
                    <span class="text-secondary text-xs font-weight-bold">{{ $pemesanan->tgl_pesan }}</span>
                  </td>
                  <td class="align-middle text-center">
                    <span class="text-secondary text-xs font-weight-bold">{{ $pemesanan->total }}</span>
                  </td>
                  
                  <form action="{{ route('pemesanan.destroy',$pemesanan->id) }}" method="Post">
                  <td class="align-middle">
                    <a class="text-danger font-weight-bold text-xs p-1 mb-2 bg-info text-white" href="{{ route('pemesanan.edit',$pemesanan->id) }}">
                      Edit
                    </a>
                  </td>
