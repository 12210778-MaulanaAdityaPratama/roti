...
<nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" navbar-scroll="true">
    <div class="container-fluid py-1 px-3">
      <nav aria-label="breadcrumb">
        ...
        <h6 class="font-weight-bolder mb-0">Tambah Data Produk</h6>
      </nav>
...
@enderror
              ...
              <label>Produk</label>
              <div class="mb-3">
                <input type="text" class="form-control" name="produk" aria-label="text" aria-describedby="text-addon">
                @error('produk')
                <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                @enderror
              ...
              <label>Harga</label>
              <div class="mb-3">
                <input type="text" class="form-control" name="harga" aria-label="text" aria-describedby="text-addon">
                @error('harga')
                <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                @enderror
              </div>
              <label>Stok</label>
              <div class="mb-3">
                <input type="text" class="form-control" name="stok" aria-label="text" aria-describedby="text-addon">
              </div>
              <label>Gambar</label>
              <div class="mb-3">
