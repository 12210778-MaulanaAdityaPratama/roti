...
<main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
    ...
    <div class="container-fluid py-1 px-3">
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
          ...
          <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Data Produk</li>
        </ol>
  ...
  </nav>        <div class="container-fluid py-1 px-3">
             ...
             @endphp
                <tr>
                  ...
                  <td class="align-middle text-center text-sm">
                    <span class="text-xs font-weight-bold mb-0">{{ $item->produk }}</span>
                  </td>
                  ...
                  <td class="align-middle text-center text-sm">
                    <img src="{{ Storage::url(''.$item->foto) }}" class="img-fluid" style="width: 200px; height: 150px;">
                  </td>
                  
                  
                  <form action="{{ route('produk.destroy',$item->id) }}" method="Post">
                  <td class="align-middle">
                    <a class="text-danger font-weight-bold text-xs p-1 mb-2 bg-info text-white" href="{{ route('produk.edit',$item->id) }}">
                      Edit
                    </a>
                  </td>
